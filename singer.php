...
<body>
    <div class="container">
        <div class="holder">
            ...
            <div class="detail">
                <h1 style="background: green; text-align: center; color: #fff;";>About Singer</h1>
                <h2>Offers For Singer</h2>
                <p>
                    <table style="">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                             ...
                             <td>We offer and provide resources to allow supportive enviroment for a singer to work successfully</td>
                        </tr>
                        <tr>
                            <td><b>Knowledge</b></td>
                            <td>We provide advanced and scientifical knowledge that will carry up singer capability</td>
                        </tr>
					...
					if($conn){
						...
						$sql="SELECT * FROM talent WHERE talent_id=9";
